...
print(f"The average temperature is {convert_sensor_data_to_dataframe(sensor_data)['Temperature'].mean():.2f}℃")
...
print(f"The average temperature per sensor is {temp_per_sensor}")
print(f"The average stress per sensor is {stress_per_sensor}")
print(f"The average displacement per sensor is {displacement_per_sensor}")
